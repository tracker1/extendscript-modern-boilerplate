...
(function (root, factory) {
    ...
    var sortIgnoresNonFunctions = false;
    ...
    var sortIgnoresUndefined = false;
    defineProperties(ArrayPrototype, {
    ...
    if (doesNotParseY2KNewYear || acceptsInvalidDates || !supportsExtendedYears) {
        ...
        (function (NativeDate) {
            ...
            NativeDate.parse = function parse(string) {
            ...
            Date.create = function(dtm) {
                if (arguments.length === 1 && typeof dtm === 'string') {
                    return new Date(Date.parse(dtm));
                }
                switch (arguments.length) {
                    ...
                    default: return new Date(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], arguments[6]);
                }
            }
        }(Date));
        /* global Date: false */
    ...
    var hasToPrecisionUndefinedBug = true;
